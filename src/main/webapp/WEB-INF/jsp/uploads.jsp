                    ...
                    <div class="container-fluid">
                        <div class="row bg-white has-shadow">
                            <div class="col-xl-12" style="text-align:center">
                                ...
                                <img class="g-login2" src="${pageContext.request.contextPath}/img/btn_google_signin_light_normal_web.png" title="Sign in with Google" onclick="location.href = '${pageContext.request.contextPath}/api/oauth/google/redirect'"><br><br><br>
                            </div>
                        </div>
                    </div>
                </section>
