...
<head>
    ...
    <title>Upload Url to Google Drive</title>
        ...
        <div class="page-content d-flex align-items-stretch">
            ...
            <nav class="side-navbar" style="min-height: 100%">
                ...
                <div class="sidebar-header d-flex align-items-center">
                    <c:choose>
                        <c:when test='${empty(user)}'>
                            <div class="avatar"><img src="${pageContext.request.contextPath}/img/guest.png" alt="Guest" class="img-fluid rounded-circle"></div>
                            <div class="title">
                                <p>Welcome</p>
                        ...
                        <c:otherwise>
                            <div class="avatar"><img src="${user.profilePhotoUrl}" alt="Avatar of <c:out value='${user.name}' />" class="img-fluid rounded-circle"></div>
                            <div class="title">
                                <p>Welcome</p>
                                <h1 class="h4">
